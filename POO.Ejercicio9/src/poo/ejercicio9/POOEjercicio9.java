...
public class POOEjercicio9 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El primer número es: " + Math.round(num1));
        matematica.setNum1(Math.round(num1));
        double num2 = Math.random()*10;
        System.out.println("El segundo número es: " + Math.round(num2));
        matematica.setNum2(Math.round(num2));
        
        matematica.devolverMayor(matematica.getNum1(), matematica.getNum2());
        matematica.calcularPotencia(matematica.getNum1(), matematica.getNum2());
        matematica.raizCuadrada(matematica.getNum1(), matematica.getNum2());
    }
}
