...
numeroCuenta (entero), el DNI del cliente (entero largo) y el saldo actual (double). 
...
public class POOEjercicio5 {
    ...
    public static void main(String[] args) {
        ...
        cuentaService.Ingresar();
        System.out.println("");
        cuentaService.Retirar();
        System.out.println("");
        cuentaService.extraccionRapida();
        System.out.println("");
        cuentaService.consultarSaldo();
        System.out.println("");
        cuentaService.consultarDatos();
    } 
}
